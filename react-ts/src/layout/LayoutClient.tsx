...
const LayoutClient = () => {
    ...
    const onSearch = (value: string) => {
         products?.filter((item:any)=>item.name === value ? navigate(`/products/${item.id}`) : undefined )
                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="md:flex md:items-center md:gap-12">
                        ...
                        <ul className="flex items-center gap-6 text-sm">
                            ...
                            <span  className="text-gray-500 transition hover:text-gray-500/75"><DropdownCate/></span>
                        ...
                        <div className="sm:flex sm:gap-4">
                            <Link to='login' className="rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white shadow">Login</Link>
                            
                            <div className="hidden sm:flex">
                            <Link className="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600" to='register'>Register</Link>
                            </div>
                        </div>
